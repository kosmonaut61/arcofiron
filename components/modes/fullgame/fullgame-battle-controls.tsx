    ...
    <div className="flex flex-col px-4 py-2 gap-1">
      ...
      <div className="flex flex-col gap-1 pt-1 border-t border-border">
        ...
        <div className="flex justify-between text-xs">
          ...
          <span className="font-medium" style={{ color: "oklch(0.65 0.15 220)" }}>
            {inventory.iron}
          </span>
        </div>
        <div className="flex justify-between text-xs">
          <span className="text-muted-foreground">copper:</span>
          <span className="font-medium" style={{ color: "oklch(0.70 0.20 60)" }}>
            {inventory.copper}
          </span>
        </div>
        <div className="flex justify-between text-xs">
          <span className="text-muted-foreground">oil:</span>
          <span className="font-medium" style={{ color: "oklch(0.40 0.05 0)" }}>
            {inventory.oil}
          </span>
        </div>
      </div>
