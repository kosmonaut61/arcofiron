...
export function BattleControls({ onOverlayChange }: BattleControlsProps) {
  const { tanks, currentTankIndex, updateTank, fireProjectile, isProcessingShot, phase } = useGameStore()
