...
import { type GameState, type Tank, WEAPONS, type Projectile, type NapalmParticle } from "@/lib/game-types"
...
interface SkirmishStore extends GameState {
  initGame: () => void
...
export const useSkirmishStore = create<SkirmishStore>((set, get) => ({
  phase: "menu",
  tanks: [],
  currentTankIndex: 0,
  terrain: [],
